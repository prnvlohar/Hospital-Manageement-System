...
class Application:
    ...
    def startpage(self):
        ...
        self.heading = Label(self.main, text="Hospital Appointment", font='Centaur 20 bold', fg='black', bg="yellow",
                             relief=SUNKEN)
        ...
        a = Radiobutton(self.main, text="Male", padx=20, font="arial 10 bold", variable=self.v, value=1,
                        bg="lightblue").place(x=130, y=210)
        b = Radiobutton(self.main, text="Female", padx=20, font="arial 10 bold", variable=self.v, value=2,
                        bg="lightblue").place(x=220, y=210)
        ...
        self.submit = Button(self.main, text="Add Appointment", font="arial 12 bold", width=15, height=2,
                             bg='lightgreen', command=self.add_appointment)
        ...
        self.logs = Label(self.main, text=" " + str(self.final_id), width=8, height=1, relief=SUNKEN).place(x=360,
                                                                                                            y=360)
    ...
    def showdetails(self):
        ...
        for i in range(len(clmnname)):
            Label(self.showdetailsframe, text=clmnname[i], font="arial 12 bold").grid(row=0, column=i * 2)
        ...
        for i in range(len(self.alldata)):
            for j in range(6):
                Label(self.showdetailsframe, text=self.alldata[i][j], font="arial 10").grid(row=count1 + 2,
                                                                                            column=count2 * 2)
    ...
    def updatee(self):
        ...
        self.search = Button(self.updateframe, text="Search", font="aried 12 bold", width=10, height=1, bg='lightgreen',
    ...
    def update1(self):
        ...
        self.update = Button(self.updateframe, text="Update", font="arial 12 bold", width=10, height=1, bg='lightgreen',
    ...
    def delete1(self):
        ...
        self.ent5.insert(END, str(self.phone))
        # buttons for update and delete
        self.update = Button(self.deleteframe, text="Delete", font="arial 12 bold", width=10, height=1, bg='lightgreen',
